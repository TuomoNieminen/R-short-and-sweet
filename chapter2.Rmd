...
- Draw a scatter plot of student shoesize versus height, with height on the y axis. 
- Use the information on the help page and make the following adjustments to the plot:
- Add this main title: "Scatter plot of student shoesize versus height".
...
*** =instructions
- Loop though the character values using the examle code. Remember that here in DataCamp, executing a command over multiple lines is done by selecting all the lines with a mouse first and then hitting `Ctrl+Enter` normally. Alternatively you could also click submit to execute the whole script.R
